...
They cannot understand or speak the local language
Typing translations is slow and inconvenient
Existing translation apps are complex or not user-friendly
Real-time conversation becomes difficult due to delays
...
🎤 Captures user speech using Speech Recognition API
📝 Converts speech into text in real time
🌐 Translates text into the selected language using MyMemory API
🔊 Converts translated text into voice using Text-to-Speech API
...
Speech Recognition API  	Voice → Text
